...
from .errors import LinkageBranchChangeError, LinkageNoSolutionError
...
class PlanarLinkageSweepResult:
    ...
    failure_error: LinkageNoSolutionError | LinkageBranchChangeError | None = None
...
def solve_planar_linkage_sweep(
    ...
    for index, driver_point in enumerate(driver_points):
        ...
        except (LinkageNoSolutionError, LinkageBranchChangeError) as error:
...
def build_reference_linkage_demo() -> LinkageDemoRig:
    ...
    final_spec = PlanarLinkageSpec(
        ...
        steering_arm_neutral_angle_rad=math.atan2(
    ...
    return LinkageDemoRig(
        ...
        driver_arc_center=neutral_driver_point,
